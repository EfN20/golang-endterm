...
func azatkaliSolution1(out io.Writer) {
	file, err := os.Open("mobydick.txt") //open file
	if err != nil {
		log.Fatal(err)
	}
...
func azatkaliSolution2(out io.Writer) {
	file, err := os.Open("mobydick.txt") //open file
	if err != nil {
		log.Fatal(err)
	}
...
func azatkaliSolution3(out io.Writer) {
	file, err := os.Open("mobydick.txt") //open file
	if err != nil {
		log.Fatal(err)
	}
...
func BenchmarkAzatkali1(b *testing.B) {
	for i := 0; i < b.N; i++ {
		azatkaliSolution1(ioutil.Discard)
	}
}

func BenchmarkAzatkali2(b *testing.B) {
	for i := 0; i < b.N; i++ {
		azatkaliSolution2(ioutil.Discard)
	}
}

// func BenchmarkAzatkali3(b *testing.B) {
// 	for i := 0; i < b.N; i++ {
// 		azatkaliSolution3(ioutil.Discard)
// 	}
// }
